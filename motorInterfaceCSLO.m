function varargout = motorInterfaceCSLO(varargin)
% MOTORINTERFACECSLO MATLAB code for motorInterfaceCSLO.fig
%      MOTORINTERFACECSLO, by itself, creates a new MOTORINTERFACECSLO or raises the existing
%      singleton*.
%
%      H = MOTORINTERFACECSLO returns the handle to a new MOTORINTERFACECSLO or the handle to
%      the existing singleton*.
%
%      MOTORINTERFACECSLO('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MOTORINTERFACECSLO.M with the given input arguments.
%
%      MOTORINTERFACECSLO('Property','Value',...) creates a new MOTORINTERFACECSLO or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before motorInterfaceCSLO_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to motorInterfaceCSLO_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help motorInterfaceCSLO

% Last Modified by GUIDE v2.5 26-Jan-2017 14:29:18

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @motorInterfaceCSLO_OpeningFcn, ...
                   'gui_OutputFcn',  @motorInterfaceCSLO_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%---------------This interface is for use on the CSLO---------------------

% --- Executes just before motorInterfaceCSLO is made visible.
function motorInterfaceCSLO_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to motorInterfaceCSLO (see VARARGIN)

% Choose default command line output for motorInterfaceCSLO
handles.output = hObject;

%Declare an Arduino Object
global a;
a = arduino('COM5', 'micro');
% disp(a);
...
% UIWAIT makes motorInterfaceCSLO wait for user response (see UIRESUME)
uiwait(handles.motorInterface);
end

% --- Outputs from this function are returned to the command line.
function varargout = motorInterfaceCSLO_OutputFcn(hObject, eventdata, handles) 
...
if handles.motorOneAngle < 0
    writeDigitalPin(a, 'D4', 1);%Select Direction of rotation
    ...
    count = 0;
    writeDigitalPin(a, 'D4', 0);%Select Direction of rotation
    while count < backtrackSteps && test == 1
